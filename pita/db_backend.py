...
class Feature(Base):
    ...
    __table_args__ = (
        UniqueConstraint("chrom", "start", "end", "strand", "ftype", name="uix_1"),
    )
    ...
    def to_loc(self):
        return "{}:{}{}{}".format(self.chrom, self.start, self.strand, self.end)

    def to_sloc(self):
        return "{}{}{}".format(self.start, self.strand, self.end)
