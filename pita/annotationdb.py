...
class AnnotationDb():
    ...
    def add_transcript(self, name, source, maxentpath, exons):
        """
        ...
        donor_score = get_splice_score(splice_donors, maxentpath, 5)
        acceptor_score = get_splice_score(splice_acceptors, maxentpath, 3)
